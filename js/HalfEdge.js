...
function HalfEdge(id){
    ...
    this.external=false;       //Refers to the external forces of the force diagram.For form diagram.Set to be false by default;
